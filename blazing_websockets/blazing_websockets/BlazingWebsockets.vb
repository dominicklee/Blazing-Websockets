...
Public Class BlazingWebsockets
    Dim dllLocation As String = System.Reflection.Assembly.GetExecutingAssembly().Location
    Dim dllDirectory As String = System.IO.Path.GetDirectoryName(dllLocation)
    ...
    Public serverRecvPath As String = dllDirectory & "\server"
    ...
    Public clientRecvPath As String = dllDirectory & "\client"
